...
type ComplexityRoot struct {
	...
	Query struct {
		...
		MyEvents        func(childComplexity int, userID int) int
	}
...
type QueryResolver interface {
	...
	MyEvents(ctx context.Context, userID int) ([]*gmodel.Event, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.myEvents":
		...
		args, err := ec.field_Query_myEvents_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.MyEvents(childComplexity, args["userId"].(int)), true
...
func (ec *executionContext) field_Query_myEvents_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 int
...
func (ec *executionContext) _Query_myEvents(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().MyEvents(rctx, fc.Args["userId"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
